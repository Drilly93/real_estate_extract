...
df_production = pd.read_csv('data/data_economie_global/production_credit_habitat.csv', sep=';')
df_taux_credit = pd.read_csv('data/data_economie_global/taux_des_credit.csv', sep=';')
df_variation_encours = pd.read_csv('data/data_economie_global/variation_encours_credit.csv' ,   sep=';')
...
df_inflation = pd.read_csv('data/data_economie_global/inflation.csv')
...
df_final.to_csv('data/data_economie_global/df_final.csv', sep=';', index=False)
print(df_final.head())