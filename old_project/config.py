...
if USER == "Abdel":
    ...
    #----------------FICHIER DATA----------------#
    # Fichier csv departements francais : code_deparement,nom_departement
    ...
    PATH_FICHIER_VAL_FONCIERE_FRANCE_CSV = PATH_DIR_VAL_FONCIERE_FRANCE / "ValeursFoncieresFrance.csv"
